...
// CommandBundle organizes CommandOptions and applies them to a antctl client or server.
...
// ApplyToRootCommand applies the CommandBundle to the root cobra command, it applies each CommandOption of it to the root
// command as a sub-command.
func (b *CommandBundle) ApplyToRootCommand(root *cobra.Command, client *Client, isAgent bool) {
